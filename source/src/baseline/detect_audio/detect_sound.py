...
def detect_audio(id_vid):
    ...
    # CSV_SUBMISSION = '../../data/BBC_processed_data/reference_bbc/audio_csv/test.csv'
...
if __name__ == '__main__':
    ...
    parser.add_argument('id_st', type=int,
                    help='ID of start')
    parser.add_argument('id_en', type=int,
                    help='ID of end')


    args = parser.parse_args()
    for id in range(args.id_st,args.id_en+1):
        detect_audio(id)
