...
def dsf(vid_id,seg_l,feat_type):
    #************************************************************************
    ...
    if vid_id != "":
        ...
        for video_name in data:
            ...
            run_dsf(cfg.PATH_DSF_BBC,cfg.VIDEO_CSV_BBC_PATH,cfg.PATH_FEATURE_VGG19_BBC,seg_l,feat_type,video_name)
    ...
    # Tvsum and SumMe
        ...
        for i in range(1,data.shape[0]):
            ...
            run_dsf(cfg.PATH_DSF_RESNET50_TVSUM,cfg.VIDEO_CSV_TVSUM_PATH,cfg.PATH_FEATURE_RESNET50_TVSUM,seg_l,feat_type,vid_id)
...
def main():
    ...
    if args.st and  args.en:
        for i in range(args.st,args.en+1):
            dsf(i,args.seg_l,args.feat_type)
    else:
        dsf("",args.seg_l,args.feat_type)
